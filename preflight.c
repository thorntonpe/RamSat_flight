...
void preflight_init_rtc()
{
    ...
    while(1)
    {
        ...
        if (ui == 's')
        {
            ...
            rtc_data[2]=0x00;   // minutes (0-59)
            rtc_data[3]=0x22;   // hour (00-23)
            rtc_data[4]=0x05;   // day of week (1-7)
            rtc_data[5]=0x13;   // day of month (1-31)
        ...
        if (ui == 'c')
        {
            ...
            write_string2("--------------------------------------");
            rtc_write_bit(HALT_REG, HALT_BIT, 0);
        }
        ...
        if (ui == 't')
        {
            ...
            write_string2("--------------------------------------");
            rtc_write_bit(STOP_REG, STOP_BIT, 0);
        }
